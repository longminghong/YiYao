...
namespace WebService
{
    ...
    public class Xueya
    {
        ...
        public string diamax { get; set; }
        public string sysmax { get; set; }
    }
    ...
    public class Xuetang
    {
        public string unit { get; set; }
        public string[] x { get; set; }
        public string[][] fastBloodSugar { get; set; }
        public string[][] randomBloodSugar { get; set; }
        public string fastmax { get; set; }
        public string randmax { get; set; }
    }
    ...
    public class Xuezhi
    {
        public string unit { get; set; }
        public string[] x { get; set; }
        public string[][] cholesteroly { get; set; }
        public string[][] triglyceridey { get; set; }
        public string[][] ldlcy { get; set; }
        public string[][] hdlcy { get; set; }
        public string cholmax { get; set; }
        public string trigmax { get; set; }
        public string ldlcmax { get; set; }
        public string hdlcmax { get; set; }
    }
